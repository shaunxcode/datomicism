...
// Generated by CoffeeScript 1.6.1
(function() {
  var Browser, BrowserView, CartographicSurface, Comment, Connection, Datom, DatomView, Emitter, Entity, EntityView, Explorer, Namespace, NamespaceView, Schema, WidgetClasses, bling, dbCombo, guid, kosherName, labelPair, textInput, _, _ref, _ref1;
  ...
  _ref = WidgetClasses = require("./widgets"), Namespace = _ref.Namespace, NamespaceView = _ref.NamespaceView, Entity = _ref.Entity, EntityView = _ref.EntityView, Browser = _ref.Browser, BrowserView = _ref.BrowserView, Datom = _ref.Datom, DatomView = _ref.DatomView;

  _ref1 = require("./Input"), labelPair = _ref1.labelPair, textInput = _ref1.textInput;
  ...
  window.DatomicIsm = {
    ...
    drawToolbar: function() {
      var $win, connectButton, el, self, stopHandler, widget, widgets, _results,
        _this = this;
      self = this;
      widgets = {};
      this.toolbar = (bling("ul", {
        "class": "toolbar"
      })).appendTo("body").append(widgets.Browser = bling("li", {
        text: "browser"
      }), widgets.Namespace = bling("li", {
        text: "namespace"
      }), widgets.Enum = bling("li", {
        text: "enum"
      }), widgets.Query = bling("li", {
        text: "query"
      }), widgets.Rules = bling("li", {
        text: "rules"
      }), widgets.Transact = bling("li", {
        text: "transact"
      }), widgets.Entity = bling("li", {
        text: "entity"
      }), widgets.Note = bling("li", {
        text: "note"
      }), widgets.Sketch = bling("li", {
        text: "sketch"
      ...
      connectButton.on({
        click: function() {
          ...
          drawDbOptions = function() {
            var host, port, _ref2, _ref3;
            if (((_ref2 = (host = self.connection.get("host"))) != null ? _ref2.length : void 0) && ((_ref3 = (port = self.connection.get("port"))) != null ? _ref3.length : void 0)) {
              return self.connection.connect(function() {
                ...
                return combo.on("changedValue", function(evt, val) {
                  var alias, db, _ref4;
                  _ref4 = (edn.parse(val)).at(":db/alias").split("/"), alias = _ref4[0], db = _ref4[1];
          ...
          modal = bling(".connectModal.modal", function() {
            var field, input, _i, _len, _ref2, _results;
            _ref2 = ["host", "port"];
            _results = [];
            for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
              field = _ref2[_i];
      ...
      for (widget in widgets) {
        el = widgets[widget];
        _results.push((function(widget, el) {
          return el.draggable({
            helper: "clone",
  ...
  Connection = (function(_super) {
    ...
    Connection.prototype.query = function(q, args, cb) {
      ...
      return $.get("/api/query", {
        ...
        return alert("Error making request. Are your transactor and rest service correctly running?");
      });
    };
...
// Generated by CoffeeScript 1.6.1
(function() {
  var Browser, BrowserView, NamespaceView, bling, kosherName, _,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
